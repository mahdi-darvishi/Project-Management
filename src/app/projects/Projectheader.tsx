...
const Projectheader = ({ activeTab, setActiveTab }: Props) => {
  ...
  return (
    <div className="px-4 xl:px-6">
      ...
      {/* TABS */}
      <div className="flex flex-wrap-reverse gap-2 border-y border-gray-200 px-2 md:items-center">
...
const TabButton = ({ name, icon, setActiveTab, activeTab }: TabButtonProps) => {
  ...
  return (
    <button
      className={`relative flex cursor-pointer items-center gap-2 px-1 py-2 text-gray-500 after:absolute after:-bottom-[9px] after:left-0 after:h-[1px] after:w-full hover:text-blue-600 sm:px-2 lg:px-4 dark:text-neutral-500 dark:hover:text-white ${
