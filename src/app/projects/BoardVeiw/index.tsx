...
type taslColumnProps = {
  status: string;
  tasks: TaskType[];
  moveTask: (taskId: number, toStatus: string) => void;
  setIsModelNewTaskOpen: (isOpne: boolean) => void;
};
      ...
      <div className="mb-3 flex w-full">
        ...
        <div className="dark:bg-dark-secondary flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              className="roudned dark:bg-dark-tertiary flex h-6 w-6 cursor-pointer items-center justify-center bg-gray-200 dark:text-white"
